...
const ContactInfo = forwardRef(({ onClose, setSuccessMessage }, ref) => {
    ...
    const handleAddToCart = async (productID) => {
        ...
        const apiUrl = 'htpp://buitoan.somee.com/api/CartProduct/Insert_CartProduct';
    ...
    const callInsertBookingAPI = async (data) => {
        ...
        try {
            const response = await fetch('htpp://buitoan.somee.com/api/Bookings/Insert_Booking', {
                method: 'POST',
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.post('htpp://buitoan.somee.com/api/ChatBox/ChatBox', payload);
    ...
    const renderMessageText = (text) => {
        const parsedText = text.replace(/Hình ảnh: ([^\s,]+(?:\.(png|jpg|jpeg|gif))?)/g, (match, filename) => {
            const imgPath = `htpp://buitoan.somee.com/wwwroot/Images/${filename}`;
                        ...
                        {msg.type === 'text' ? (
                            ...
                            <div className={cx('product-item')}>
                                ...
                                {msg.data.productImages && (
                                    <img
                                        src={`htpp://buitoan.somee.com/wwwroot/Images/${msg.data.productImages}`}
                                        alt="Product Image"
